...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "Real-Estate-Broker-Commission-Claim",
  });
...
export default async function REBCCPage({ params: { locale } }: { params: { locale: string } }) {
  setRequestLocale(locale);
  const t = await getTranslations('Real-Estate-Broker-Commission-Claim');
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="relative w-1/2 h-[420px]">
            <Image
              src="/real-estate-broker-commission-claim-hero-1200x500.jpg"
              alt="Real Estate Broker Commission Claim Banner"
              fill
        ...
        <div className="grid grid-cols-2 gap-16 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-600 text-2xl leading-relaxed whitespace-pre-line">
